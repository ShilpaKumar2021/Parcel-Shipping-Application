...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_Shipping Label Requests/ddl_SelectACarrier'),3)
...
for(int i=1; i<=Integer.parseInt(getXlsRowCount); i++) 
{
	...
	//Enter the value for the required fifindTestObject('Object Repository/Page_Shipping Label Requests/ddl_SelectACarrier')eld

	WebUI.selectOptionByLabel(findTestObject('Object Repository/Page_Shipping Label Requests/ddl_SelectACarrier'), strCarrierType, true)

	WebUI.selectOptionByLabel(findTestObject('Object Repository/Page_Shipping Label Requests/ddl_SelectACarrier'), strCarrierType, true)

	WebUI.delay(5) // this is required in order to load the values from droplist
	WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Shipping Label Requests/ddl_SelectSMARTParcelAPI_ID'),strSartParcelId,true)
	
	WebUI.setText(findTestObject('Object Repository/Page_Shipping Label Requests/input_Address 1'), strAddress1)
	WebUI.setText(findTestObject('Object Repository/Page_Shipping Label Requests/input_Address 2'), strAddress2)
	WebUI.setText(findTestObject('Object Repository/Page_Shipping Label Requests/input_City'), strCity)
	WebUI.setText(findTestObject('Object Repository/Page_Shipping Label Requests/input_PostalCode'), strPostalCode)
	WebUI.setText(findTestObject('Object Repository/Page_Shipping Label Requests/input_State'), strState)
	WebUI.setText(findTestObject('Object Repository/Page_Shipping Label Requests/input_CountryCode'), strCountry)
	
	//To check RES is selected or not
	if(strRes.contains('Yes'))
	{
		WebUI.click(findTestObject('Object Repository/Page_Shipping Label Requests/checkbox_Res'))
	}
	
	WebUI.click(findTestObject('Object Repository/Page_Shipping Label Requests/button_ValidateAddress'))
	String outputText = WebUI.getText(findTestObject('Object Repository/Page_Shipping Label Requests/label_AddressValidation'))	
	System.out.println(outputText)
	assert WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Shipping Label Requests/label_AddressValidation')) == true : outputText
